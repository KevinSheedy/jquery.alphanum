...
(function( $ ){
	...
	$.fn.numeric = function(settings) {
		...
		$collection.bind("blur.alphanum", numericField_Blur)
	...
	function setupEventHandlers($textboxes, trimFunction, settings) {
		...
		$textboxes.each(function(){
			...
			var $textbox = $(this);
			$textbox.unbind(".alphanum");

			$textbox.bind("keyup.alphanum change.alphanum paste.alphanum", function(){
			...
			$textbox.bind("keypress.alphanum", function(e){
